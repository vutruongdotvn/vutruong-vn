  ...
  return (
    <div className="postAction flex items-center gap-5 px-4 py-3">
      ...
      <button
        ...
        className="likeBtn cursor-pointer text-base text-muted-foreground transition hover:text-foreground focus-visible:outline-none active:scale-80 sm:text-base lg:text-lg"
      >
      ...
      <button
        ...
        className="commentBtn cursor-pointer text-base text-muted-foreground transition hover:text-foreground focus-visible:outline-none active:scale-80 sm:text-base lg:text-lg"
      >
      ...
      <button
        ...
        aria-busy={sharing}
        className="shareBtn cursor-pointer text-base text-muted-foreground transition hover:text-foreground focus-visible:outline-none active:scale-80 disabled:cursor-wait disabled:opacity-50 sm:text-base lg:text-lg"
        title="Chia sẻ"
      >
        <i
          className={
