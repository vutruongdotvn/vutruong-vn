...
type ModalFullPostSkeletonProps = {
  onClose: () => void;
};
  ...
  return (
    <div className="fixed inset-0 z-[9998] flex items-center justify-center">
      ...
      <section
        ...
        aria-busy="true"
        aria-live="polite"
        className="modal-loading-text relative z-10 flex max-h-[100dvh] min-h-0 w-full max-w-2xl flex-col overflow-hidden bg-white sm:w-[min(80vw,44rem)] sm:rounded-2xl lg:max-h-[80dvh]"
      >
        <CloseButton buttonRef={textCloseButtonRef} onClose={close} />
