    ...
    <div className="relative">
      <div className="grid grid-cols-[56px_1fr] gap-2 md:gap-3 animate-pulse">
        ...
        <div className="relative flex flex-col items-center">
          ...
          {/* Dot */}
          <div className="relative z-10 mt-3 w-3 h-3 rounded-full bg-gray-300 border-2 border-white shadow-sm" />
        </div>

        {/* RIGHT CONTENT */}
        <div className="pb-10 pt-2">
          <div className="w-full rounded-[28px] bg-white/80 border border-white/70 shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-5">
            {/* Header */}
            ...
            {/* Image */}
            <div className="bg-gray-200 w-full aspect-video rounded-[24px] mt-5" />
