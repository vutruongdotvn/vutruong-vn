        ...
        {tabs.map((tab) => {
          ...
          return (
            <Link
              ...
              className="relative flex shrink-0 items-center gap-2 border-b-3 border-transparent px-3 sm:px-5 py-3 sm:py-4 rounded-md hover:bg-muted active:scale-98"
            >
              ...
              {isActive && (
                <motion.span
                  ...
                  className="pointer-events-none absolute inset-x-0 -bottom-[3px] h-[3px] bg-nav-indicator"
                  aria-hidden="true"
                />
              )}
            </Link>
