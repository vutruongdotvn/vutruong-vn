...
export default function PremiumGlassCard({
  ...
  return (
    ...
    <div className={cn("group relative w-full mx-auto px-0 sm:px-4", className)}>
      ...
      <div
        className={cn(
          "relative overflow-hidden rounded-0 sm:rounded-[1.5rem] border border-white/60 bg-white/90 backdrop-blur-2xl",
      ...
      >
        ...
        <div
          className="pointer-events-none absolute inset-0 opacity-[0.0345] mix-blend-overlay"
          style={{
            backgroundImage: `
