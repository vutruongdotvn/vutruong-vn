...
export default function CvSectionCard({
  ...
  return (
    <section
      className={cn(
        "cv-section-card overflow-hidden rounded-2xl border border-border bg-card shadow-[0_18px_60px_rgba(15,23,42,0.06)]",
        className,
      )}
    >
      <header className="relative isolate flex items-center gap-4 overflow-hidden bg-[#111216] p-3 sm:p-4 text-white">
        <div
        ...
        <span className="grid size-12 shrink-0 place-items-center rounded-2xl border border-white/10 bg-white/[0.08] text-lg text-white shadow-inner shadow-white/5">
