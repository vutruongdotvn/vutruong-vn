...
async function getCategoryMovies(slug: string, page: string = "1") {
  const res = await fetch(`https://ophim1.com/v1/api/the-loai/${slug}?page=${page}`, {
