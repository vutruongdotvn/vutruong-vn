...
async function getCountryMovies(slug: string, page: string = "1") {
  const res = await fetch(`https://ophim1.com/v1/api/quoc-gia/${slug}?page=${page}`, {
...
export default async function CountryPage({
  ...
  const data = await getCountryMovies(slug, page);
