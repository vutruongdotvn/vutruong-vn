  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <div className="mx-auto flex min-h-screen w-full max-w-[1200px] flex-col items-center px-6 pb-16 pt-14">
        {/* Date */}
        <p className="mb-1 text-center text-2xl font-medium tracking-tight text-foreground md:text-[32px]">
          {formattedDate}
        </p>

        {/* Clock */}
        <h1
          className="select-none text-center font-black leading-none tracking-[-0.016em] text-foreground"
          style={{
        ...
        >
          <div className="flex h-[56px] w-full max-w-[560px] items-center rounded-full bg-card px-5 shadow-sm">
            ...
            <input
              ...
              className="h-full w-full bg-transparent text-[17px] text-foreground/75 outline-none placeholder:text-muted-foreground"
              autoComplete="off"
              spellCheck={false}
            />
          </div>
